...
export default function SocialShare({ url, title, description, imageUrl, compact = false }) {
    ...
    return (
      <div className="flex items-center gap-2">
        ...
        <button
          ...
          className="w-8 h-8 rounded-full bg-gray-600 hover:bg-gray-700 text-white flex items-center justify-center transition-colors"
