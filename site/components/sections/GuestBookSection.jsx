...
export default function GuestBookSection() {
  return (
    <section id="guestbook" className="section-elegant bg-gradient-to-br from-ivory via-blush-50/20 to-ivory">
      <div className="container mx-auto px-4 max-w-6xl">
        <SectionTransition>
          <div className="card-elegant p-12 text-center">
            ...
            <h2 className="font-display text-5xl md:text-7xl text-gradient-elegant mb-6">Guest Book</h2>
